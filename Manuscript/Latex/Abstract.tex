...
\title{Life expectancy and lifespan disparity in Eastern Europe and the contribution of alcohol related mortality}
...
At the same time, our results revealed a paradox of sorts. On the one hand, between-country differences in lifespan variation were more stable than between-country differences in life expectancy. On the other hand, changes in lifespan variation were more sensitive to year-to-year mortality fluctuations than life expectancy. This could be a result of the nonlinear relationship between changes in age-specific mortality and life disparity. For instance, if mortality is concentrated in a range in which the threshold age is in the middle, then the effect of these ages would be offset. Thus changes in life disparity would depend mainly on young-age mortality. In our set of countries. Most young-age mortality fluctuations were caused by external causes, which can fluctuate more in the short term and could cause life disparity to be more volatile than life expectancy.
\\
