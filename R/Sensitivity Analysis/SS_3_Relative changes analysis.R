...
Prop.fig.1.CI 
###########################
Prop.fig.T <- c(Prop.fig,Prop.figf)
Prop.fig.TCI <- c(Prop.fig.CI,Prop.fig.CIf)

Prop.fig.1T <- c(Prop.fig.1,Prop.fig.1f)
Prop.fig.1TCI <- c(Prop.fig.1.CI,Prop.fig.1.CIf)
